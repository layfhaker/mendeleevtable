window.REACTIONS_DB = {
  ...
  "reaction_rules": [
    ...
    },
    {
      ...
      "name": "?????????? ???????? ? ?????? (???????)",
      "class": "amphoteric",
      "trigger": "Al/Zn ??? Al2O3/ZnO/Al(OH)3/Zn(OH)2 + NaOH(KOH) + H2O",
      "products_pattern": "?????????/???????, ??? ???????? ? H2?",
      "examples": [
    ...
    },
    {
      ...
      "name": "????. H2SO4 + HBr/HI",
      "class": "redox",
      "trigger": "H2SO4(conc) + HBr/HI",
      "products_pattern": "H2SO4 ?????????????????, ???????????????? ??????????",
      "examples": [
    ...
    },
    {
      ...
      "name": "????????????? (????????? ???????)",
      "class": "redox",
      "trigger": "metal oxide + Al + heat",
      "products_pattern": "Al2O3 + ??????",
      "examples": [
        "Fe2O3 + 2Al ? Al2O3 + 2Fe",
        "Cr2O3 + 2Al ? Al2O3 + 2Cr"
      ]
    ...
    },
    {
      ...
      "name": "NH3 / NOx ???????????",
      "class": "redox",
      "trigger": "NH3+O2, NO+O2, NO2+H2O, N2O4",
      "products_pattern": "NO/NO2/??????? ????? ? ??????????? ?? ???????",
      "examples": [
        "4NH3 + 5O2 ? 4NO + 6H2O",
        "2NO + O2 ? 2NO2",
        "2NO2 + H2O ? HNO2 + HNO3",
    ...
    },
    {
      ...
      "name": "SO2/SO3: ????????? ? ??????????????",
      "class": "redox",
      "trigger": "SO2 + O2 or SO2 + Br2 + H2O",
      "products_pattern": "SO3/H2SO4",
      "examples": [
        "2SO2 + O2 ? 2SO3",
    ...
    },
    {
      ...
      "products_pattern": "??????? ????????????? ?????????",
      "examples": [
        "2KMnO4 + 10FeCl2 + 8H2SO4 ? K2SO4 + 2MnSO4 + 5Fe2(SO4)3 + 20HCl + 8H2O",
    ...
    },
    {
      ...
      "name": "???????? ????????/????????/????????",
      "class": "hydrolysis",
      "trigger": "carbide/nitride/phosphide + H2O",
      "products_pattern": "????????? + ???",
      "examples": [
    ...
    },
    {
      ...
      "name": "NO2 + ?????? (?????????????????????)",
      "class": "redox",
      "trigger": "NO2 + NaOH/KOH",
      "products_pattern": "?????? + ?????? + H2O",
      "examples": [
    ...
    },
    {
      ...
      "name": "???????? ???????????",
      "class": "thermal",
      "trigger": "KClO3/KMnO4/NH4NO2 + heat",
      "products_pattern": "?????????? ? ?????????? O2/N2",
      "examples": [
        "2KClO3 ? 2KCl + 3O2?",
    ...
    },
    {
      ...
      "name": "?????????????? ??????? CO",
      "class": "redox",
      "trigger": "metal oxide + CO + heat",
      "products_pattern": "?????? + CO2",
      "examples": [
        "Fe2O3 + 3CO ? 2Fe + 3CO2"
      ]
    },
    {
      ...
      "name": "?????????????? ??????? ?????????",
      "class": "redox",
      "trigger": "metal oxide + C + heat",
      "products_pattern": "?????? + CO/CO2",
      "examples": [
        "2Fe2O3 + 3C ? 4Fe + 3CO2",
        "ZnO + C ? Zn + CO"
      ]
  ...
  "rule_exceptions": [
    ...
    },
    {
      "exception_id": "E65",
      "rule_id": "R03",
      "description": "?????????????? Fe/Al/Cr ???????? ????. HNO3",
      "forbidden_pattern": "Fe/Al/Cr + HNO3(????, ????????)",
      "reason": "? ???????? ????????????????? HNO3 Fe, Al, Cr ????????????? ? ?????? ?? ?????????.",
      "priority": 1
    },
    {
      "exception_id": "E66",
      "rule_id": "R04",
      "description": "?????????????? Fe/Al/Cr ???????? ????. H2SO4",
      "forbidden_pattern": "Fe/Al/Cr + H2SO4(????, ????????)",
      "reason": "? ???????? ????????????????? H2SO4 Fe, Al, Cr ?????????????.",
      "priority": 1
    },
    {
      "exception_id": "E67",
      "rule_id": "R41",
      "description": "?????? ??? Cl2 + NaOH ?????????? ?????? ??? ??????????",
      "forbidden_pattern": "Cl2 + NaOH -> NaCl + NaClO3 (??? ???????)",
      "reason": "??? ??????? ??????? ??????????: Cl2 + 2NaOH -> NaCl + NaClO + H2O.",
      "priority": 2
    },
    {
      "exception_id": "E68",
      "rule_id": "R41",
      "description": "?????????? ??? ??????? ?????? ?? ???????? ???????? ?????????",
      "forbidden_pattern": "Cl2 + NaOH(???, t?) -> NaCl + NaClO",
      "reason": "??? ?????????? ? ????????????????? ?????? ???????? ??????? ? ?????? NaClO3.",
      "priority": 2
    },
    {
      "exception_id": "E69",
      "rule_id": "R45",
      "description": "???????? Cu(II)-?????? ??????? ??????? NH3",
      "forbidden_pattern": "Cu(OH)2 + NH3 -> [Cu(NH3)4](OH)2 (??? ???????)",
      "reason": "?????????????????? ???????? ??? ??????? ???????.",
      "priority": 2
    },
    {
      ...
      "rule_id": "R23",
      "description": "???? ??????? ??????? ? ???????? ????????? ?? ?????????????",
      "forbidden_pattern": "NaCl/KNO3/K2SO4 + H2O -> ????????",
      "reason": "???????? ????? ????? ?????? ? ???????????, ???????? ??????????? ???????????.",
      "priority": 1
    },
    {
    ...
    },
    {
      ...
      "rule_id": "R38",
      "description": "K2Cr2O7 ??????? ?????? ????? ??? ??????? ???????? ???",
      "forbidden_pattern": "K2Cr2O7 + ?????????????? (??? ???????) -> Cr(III)",
      "reason": "??? ??????? ????????? K2Cr2O7 ??? ?????????? ????????????? ? ?????? ?????.",
      "priority": 2
    },
    {
      "exception_id": "E74",
      "rule_id": "R42",
      "description": "????. H2SO4 ? HBr/HI ?? ???????? ? ???????? ????????-????????? ??????",
      "forbidden_pattern": "H2SO4(????) + HBr/HI -> ?????? ???? + ???????",
      "reason": "????? ???? ???: ?????????? Br2/I2 ? ???????? ?????????????? ?????? ???????.",
      "priority": 1
    },
    {
      "exception_id": "E75",
      "rule_id": "R57",
      "description": "KClO3 ?????? ????????? ??? ?????????? (????? ? ????????????? MnO2)",
      "forbidden_pattern": "KClO3 -> KCl + O2 (??? ???????)",
      "reason": "??? ?????????? ?????????? ??????????? ?? ????.",
      "priority": 2
    },
    {
      ...
      "rule_id": "R57",
      "description": "KMnO4 ??????????? ??? ??????????",
      "forbidden_pattern": "KMnO4 -> K2MnO4 + MnO2 + O2 (??? ???????)",
      "reason": "??? ????????? ?????????? ????? ??????.",
      "priority": 2
    },
    {
      ...
      "rule_id": "R58",
      "description": "?????????????? CO ??????? ???????",
      "forbidden_pattern": "Fe2O3 + CO -> Fe + CO2 (??? ???????)",
      "reason": "? ??????????? ???????? ??????? ??????????? ?? ????.",
      "priority": 2
    },
    {
      ...
      "rule_id": "R59",
      "description": "?????????????? ??????? ????????? ??????? ??????? ???????????",
      "forbidden_pattern": "Fe2O3 + C -> Fe + CO2 (??? ???????)",
      "reason": "??????? ???? ??? ????????????/? ????.",
      "priority": 2
    },
    {
      ...
      "rule_id": "R56",
      "description": "Cl2 + H2O ? ????????? ??????????, ?? ?????? ???????????",
      "forbidden_pattern": "Cl2 + H2O -> ?????? HCl + HClO (??? ???????????)",
      "reason": "??????? ????????, ????? ???????? ???????? ????.",
      "priority": 3
    }
  ],
  "reaction_examples": [
    ...
    },
    {
      "example_id": "EX164",
      "rule_id": "R36",
      "reactants": "2KMnO4 + 10FeSO4 + 8H2SO4",
      "products": "K2SO4 + 2MnSO4 + 5Fe2(SO4)3 + 8H2O",
      "equation": "2KMnO4 + 10FeSO4 + 8H2SO4 ? K2SO4 + 2MnSO4 + 5Fe2(SO4)3 + 8H2O",
      "notes": "????????? ??????????? ??????? ?????????????? ??????"
    },
    {
      "example_id": "EX165",
      "rule_id": "R36",
      "reactants": "2KMnO4 + 10KI + 8H2SO4",
      "products": "2MnSO4 + 5I2 + 6K2SO4 + 8H2O",
      "equation": "2KMnO4 + 10KI + 8H2SO4 ? 2MnSO4 + 5I2 + 6K2SO4 + 8H2O",
      "notes": "????????? ??????????? ??????? ?????????????? ??????"
    },
    {
      "example_id": "EX166",
    ...
    },
    {
      "example_id": "EX167",
      "rule_id": "R39",
      "reactants": "2Al + 2NaOH + 6H2O",
      "products": "2Na[Al(OH)4] + 3H2?",
    ...
    },
    {
      "example_id": "EX170",
      "rule_id": "R41",
      "reactants": "3Cl2 + 6NaOH",
      "products": "5NaCl + NaClO3 + 3H2O",
      "equation": "3Cl2 + 6NaOH ? 5NaCl + NaClO3 + 3H2O",
      "notes": "????????? ??????????? ??????? ?????????????? ??????"
    },
    {
      "example_id": "EX171",
      "rule_id": "R42",
      "reactants": "H2SO4(????) + 2HBr",
      "products": "SO2? + Br2 + 2H2O",
      "equation": "H2SO4(????) + 2HBr ? SO2? + Br2 + 2H2O",
      "notes": "????????? ??????????? ??????? ?????????????? ??????"
    },
    {
      "example_id": "EX172",
    ...
    },
    {
      "example_id": "EX173",
      "rule_id": "R44",
      "reactants": "2Na2O2 + 2CO2",
      "products": "2Na2CO3 + O2?",
      "equation": "2Na2O2 + 2CO2 ? 2Na2CO3 + O2?",
      "notes": "????????? ??????????? ??????? ?????????????? ??????"
    },
    {
      "example_id": "EX174",
    ...
    },
    {
      "example_id": "EX179",
      "rule_id": "R48",
      "reactants": "SO2 + Br2 + 2H2O",
      "products": "H2SO4 + 2HBr",
      "equation": "SO2 + Br2 + 2H2O ? H2SO4 + 2HBr",
      "notes": "????????? ??????????? ?????????????? ??????"
    },
    {
      "example_id": "EX180",
    ...
    },
    {
      "example_id": "EX184",
      "rule_id": "R51",
      "reactants": "2KMnO4 + 10FeCl2 + 8H2SO4",
      "products": "K2SO4 + 2MnSO4 + 5Fe2(SO4)3 + 20HCl + 8H2O",
      "equation": "2KMnO4 + 10FeCl2 + 8H2SO4 ? K2SO4 + 2MnSO4 + 5Fe2(SO4)3 + 20HCl + 8H2O",
      "notes": "????????? ??????????? ?????????????? ??????"
    },
    {
      "example_id": "EX185",
      "rule_id": "R51",
      "reactants": "5KI + KIO3 + 3H2SO4",
      "products": "3I2 + 3K2SO4 + 3H2O",
      "equation": "5KI + KIO3 + 3H2SO4 ? 3I2 + 3K2SO4 + 3H2O",
      "notes": "????????? ??????????? ?????????????? ??????"
    },
    {
      "example_id": "EX186",
    ...
    },
    {
      ...
      "rule_id": "R53",
      "reactants": "AlN + 3H2O",
      "products": "Al(OH)3 + NH3?",
      "equation": "AlN + 3H2O ? Al(OH)3 + NH3?",
      "notes": "????????? ??????????? ?????????????? ??????"
    },
    {
      "example_id": "EX189",
      "rule_id": "R53",
      "reactants": "Ca3P2 + 6H2O",
      "products": "3Ca(OH)2 + 2PH3?",
      "equation": "Ca3P2 + 6H2O ? 3Ca(OH)2 + 2PH3?",
      "notes": "????????? ??????????? ?????????????? ??????"
    },
    {
      "example_id": "EX190",
      "rule_id": "R55",
      "reactants": "2NO2 + 2NaOH",
      "products": "NaNO2 + NaNO3 + H2O",
      "equation": "2NO2 + 2NaOH ? NaNO2 + NaNO3 + H2O",
      "notes": "?????????????? ???????????? ????????"
    },
    {
      "example_id": "EX191",
